...
export interface ApiBookBook extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    age: Schema.Attribute.Enumeration<['child', 'youth', 'adult']>;
...
export interface ApiThemeTheme extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::theme.theme'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    theme: Schema.Attribute.Enumeration<['standard', 'sale', 'darkmode']> &
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    role: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.role'
    >;
    starred: Schema.Attribute.Relation<'manyToMany', 'api::book.book'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    username: Schema.Attribute.String &
